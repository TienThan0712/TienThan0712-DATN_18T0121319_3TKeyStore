...
public interface IProductService<T> {
	...
	public int editProductInfo(String MaSP, String AnhSP, String TenSP, Long DonGia, Integer GiamGia, String MaLoai, Date NgayThem, String MoTa);
	public int editProductInfoNotImage(String MaSP, String TenSP, Long DonGia, Integer GiamGia, String MaLoai, Date NgayThem, String MoTa);
