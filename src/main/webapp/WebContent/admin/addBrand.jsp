					...
					<div class="position-center">
						<form role="form" action="/admin/addCategory" method="post">
							<div class="form-group">
								<label style="color: black; font-size: 20px">Mã loại switch</label> <input type="text" name="maloai"
									class="form-control" id="exampleInputEmail1"
									placeholder="Nhập mã loại">
							</div>
							<div class="form-group">
								<label style="color: black; font-size: 20px">Tên loại switch</label> <input type="text" name="tenloai"
