			...
			<div class="row">
				<div class="col-md-12">
					<div class="position-center">
						<form role="form" action="/admin/editCategory" method="post">
							<div class="form-group">
								<label style="color: black; font-size: 20px">Mã loại switch</label> <input type="text" name="maloai" class="form-control"
									id="exampleInputEmail1" readonly="readonly"
									value="red">
							</div>
							<div class="form-group">
								<label style="color: black; font-size: 20px">Tên loại switch</label> <input type="text" name="tenloai" class="form-control"
									id="exampleInputPassword1" value="Red Switch">
							</div>
