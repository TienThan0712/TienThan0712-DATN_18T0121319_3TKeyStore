...
<body>
	...
	<div id="page-wrapper">
		<div class="header">
			<h1 class="page-header">Danh sách đơn hàng chờ xác nhận</h1>
		</div>
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
											...
											<tr>
												...
												<td class="center"><a
													href="/admin/orderDetail?mahd=${s.getMaHD()}&name=btnChiTiet">
														Chi tiết</a></td>
												<td class="center"><a
													href="/admin/orderWaiting?mahd=${s.getMaHD()}&name=btnHuyDon">
														Hủy đơn</a> <span>|</span> <a
													href="/admin/orderWaiting?mahd=${s.getMaHD()}&name=btnXacNhan">
														Xác nhận</a></td>
											</tr>
										</c:forEach>
									</tbody>
