...
<body>
	...
	<div id="page-wrapper">
		<div class="header">
			<h1 class="page-header">Thêm loại switch</h1>
		</div>
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="position-center">
						<form role="form" action="/admin/addSwitch" method="post">
							<div class="form-group">
								<label style="color: black; font-size: 20px">Mã loại switch</label> <input type="text" name="maswitch"
									class="form-control" id="exampleInputEmail1"
									placeholder="Nhập mã loại switch">
							</div>
							<div class="form-group">
								<label style="color: black; font-size: 20px">Tên loại switch</label> <input type="text" name="tenswitch"
									class="form-control" id="exampleInputPassword1"
									placeholder="Nhập tên loại switch">
							</div>
