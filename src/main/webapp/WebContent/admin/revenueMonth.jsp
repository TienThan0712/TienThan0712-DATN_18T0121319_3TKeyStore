								...
								<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th class="center">Doanh thu của tháng</th>
											<th class="center">Hành động</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${revenueMonth}" var="s">
											<form>
												<tr class="">
													<td class="center">${s.getMonth()}</td>
													<td class="center"><fmt:formatNumber type="NUMBER"
														value="${s.getTotalPrice()}" />đ</td>
													<td class="center"><a
														href="/admin/revenueDay?month=${s.getMonth()}">Chi tiết</a>
													</td>
												</tr>
											</form>
										</c:forEach>
