				...
				<div class="account-page-tab-content m-4">
					...
					<div class="tab-content">
						<div class="tab-pane fade show active pl-4 " id="nav-taikhoan"
							...
							<form action="/home/customerDetail?makh=${sessionScope.kh.getMaKH()}">
								<div class="hoten my-3">
									<div class="row">
										<label class="col-md-2 offset-md-2" for="account-hoten">Họ tên</label> 
										<input class="col-md-4" type="text" name="HoTen" value="${sessionScope.kh.getHoTen()}">
									</div>
								</div>
								<div class="email my-3">
									<div class="row">
										<label class="col-md-2 offset-md-2" for="account-email">Địa chỉ email</label> 
										<input class="col-md-4" type="text" name="Email" value="${sessionScope.kh.getEmail()}">
									</div>
								</div>
								<div class="sdt my-3">
									<div class="row">
										<label class="col-md-2 offset-md-2" for="account-hoten">Số điện thoại </label> 
										<input class="col-md-4" type="text" name="SoDT" value="${sessionScope.kh.getSoDT()}">
									</div>
								</div>
								<div class="diachi my-3">
									<div class="row">
										<label class="col-md-2 offset-md-2" for="account-hoten">Địa chỉ</label> 
										<input class="col-md-4" type="text" name="DiaChi" value="${sessionScope.kh.getDiaChi()}">
									</div>
								</div>
								<div class="capnhat my-3">
									<div class="row">
										<button type="submit"class="button-capnhat text-uppercase offset-md-4 btn btn-warning mb-4" name="btnUpdate" >Cập nhật</button>
									</div>
								</div>
							</form>
								...
								<div class="thay-doi-mk">
									<div class="mkcu my-3">
										<div class="row">
											...
											<input class="col-md-4" type="password" name="PassCu" value="">
										</div>
									</div>
									<div class="mkmoi my-3">
										<div class="row">
											<label class="col-md-2 offset-md-2" for="account-mkmoi">Mật khẩu mới</label> 
											<input class="col-md-4" type="password" name="PassMoi" value="">
										</div>
									</div>
									<div class="capnhat my-3">
										<div class="row">
											<button type="submit" name="btnDoiMK" class="button-capnhat text-uppercase offset-md-4 btn btn-warning mb-4">Cập nhật</button>
										</div>
									</div>
								</div>
							</form>
