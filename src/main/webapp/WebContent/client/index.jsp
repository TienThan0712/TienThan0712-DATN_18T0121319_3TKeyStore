                ...
                <div class="col-md-3">
                    <div class="categoryheader">
                        <div class="noidungheader text-white">
                            ...
                            <span class="text-uppercase font-weight-bold ml-1">Danh mục thương hiệu</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="benphai float-right">
                        <div class="hotline">
                            ...
                            <span>Hotline:<b>038 584 2033</b> </span>
                        </div>
                        ...
                        <ul>
                            <c:forEach items="${dsloai}" var="s"> 
					           <li class="liheader"><a href="#" class="header text-uppercase">
					             <a href="/home/category?ml=${s.getMaloai()}"> ${s.getTenloai()} </a>
                               </li>
				   			</c:forEach>
                        </ul>
                    </div>
                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#"><img src="https://akkogear.com.vn/wp-content/uploads/2021/03/AKKO_3087_3108_v2_DS_Horizon_Banner.jpg" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="First slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="https://akkogear.com.vn/wp-content/uploads/2021/03/AKKO_Monets__POND_BANNER.jpg" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="Second slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="https://akkogear.com.vn/wp-content/uploads/2020/12/matchabanner.jpg" class="img-fluid"
            ...
            <div class="noidung" style=" width: 100%;">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-transparent pt-4">
                        <h1 class="header text-uppercase" style="font-weight: 400;">BÀN PHÍM MỚI TUYỂN CHỌN</h1>
                        <a href="/home/productNew" class="btn btn-warning btn-sm text-white">Xem tất cả</a>
                    </div>
                </div>
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                    ...
                    <c:forEach items="${dsspmoi}" var="s">
	                	<div class="card">
	                        <a href="/home/productDetail?masp=${s.getMaSP()}" class="motsanpham"
	                            style="text-decoration: none; color: black;" data-toggle="tooltip" data-placement="bottom"
	                            title="#">
	                            <img class="card-img-top anh" src="/${s.getAnhSP()}"
	                                alt="#">
	                            <div class="card-body noidungsp mt-3">
	                                <h3 class="card-title ten">${s.getTenSP()}</h3>
	                                <small class="thuonghieu text-muted">${s.getTenLoai()}</small>
	                                <div class="gia d-flex align-items-baseline">
	                                    <div class="giamoi"><fmt:formatNumber type="NUMBER" value="${s.getGiaSale()}"/>đ</div>
	                                    <div class="giacu text-muted"><fmt:formatNumber type="NUMBER" value="${s.getDonGia()}"/>đ</div>
            ...
            <div class="noidung bg-white" style=" width: 100%;">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-light">
                        <h2 class="header text-uppercase" style="font-weight: 400;">BÀN PHÍM HOT - GIẢM ĐẾN 25%</h2>
                        <a href="/home/productHot" class="btn btn-warning btn-sm text-white">Xem tất cả</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="noidung" style=" width: 100%;">
                <div class="row">
                    <!--header-->
                    <div class="col-12 d-flex justify-content-between align-items-center pb-2 bg-transparent pt-4">
                        <h2 class="header text-uppercase" style="font-weight: 400;">CẨM NANG</h2>
                    ...
                    <div class="col-lg col-sm-4">
                        <div class="card">
                            <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                                ...
                                title="#">
                                <img class="card-img-top anh" src="https://siliconz.vn/storage/images/ban-phim-co-custom-2048x1152.jpg"
                                    alt="#">
                                <div class="card-body noidungsp mt-3">
