		...
		<div class="container">
			<ol class="breadcrumb mb-0 p-0 bg-transparent">
				...
				<li class="breadcrumb-item active"><a href="ProductController">
						${sessionScope.loai.getTenloai()}</a></li>
			</ol>
		</div>
	</section>
	...
	<section class="banner">
		<div class="container">
			<a href="sach-moi-tuyen-chon.html"><img
				src="https://sp-ao.shortpixel.ai/client/to_auto,q_lossy,ret_img,w_1020,h_372/https://akko.vn/wp-content/uploads/2021/10/ban-phim-co-akko-mojike-banner-1920x700-01-Akkovn-1400x510.jpg" alt="banner-sach-ktkn"
				class="img-fluid"></a>
		</div>
	</section>
								...
								<ul class="pagination justify-content-center">
									...
									<c:forEach begin="${beginProduct}" end="${endProduct}" var="i">
										<li
											...
											class="page-link" href="/home/category/page/${i}">${i}</a></li>
									</c:forEach>
									...
									<li class="page-item"><a class="page-link"
										href="/home/category/page/${totalPageCount}" aria-label="Next">
